import { state, normalizeToken } from './state.js';

// Dev-compat switch: default OFF; enable by setting localStorage.authDevCompat = '1'
            ...
            if (r.ok) {
                ...
                if (newToken) {
                    ...
                    if (body !== undefined && typeof body === 'object' && body !== null && method.toUpperCase() !== 'GET') {
                        const bodyObj = { ...body };
                        if (AUTH_DEV_COMPAT) bodyObj.token = newToken;
